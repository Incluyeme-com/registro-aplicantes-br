module.exports = class Args {
  ...
  mesclar(args) {
    ...
    this.afterFormat = typeof args.afterFormat === 'função' ? args.afterFormat : this.afterFormat;
    this.beforeFormat = typeof args.beforeFormat === 'função' ? args.beforeFormat : this.beforeFormat;
