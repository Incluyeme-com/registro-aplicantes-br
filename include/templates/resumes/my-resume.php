...
wp_register_script('jqueryMoney', $js . 'jquery.maskMoney.js');
		...
		<div class="container">
			...
			<template id="step4">
				...
				<div class="container">
					...
					<x-incluyeme class="row align-items-center">
						<x-incluyeme class="col-lg-4 col col-md-12 mb-3 mb-sm-0">
							<input type="text" min='0' v-model="mPhone" class="form-control" id="mPhone"
				...
				<div class="container mt-3 mb-sm-0">
					...
					<x-incluyeme class="row align-items-center">
						<x-incluyeme class="col-lg-4 col col-md-12 mb-3 mb-sm-0">
							<input type="text" min='0' v-model="fPhone" class="form-control" id="fPhone"
							       placeholder="Código da Área">
						</x-incluyeme>
						<x-incluyeme class="col-1 text-center d-none d-lg-block">
							<span><b>-</b></span>
						...
						<x-incluyeme class="col-lg-7 col-md-12">
							<label for="fiPhone" style="display: none"></label>
							<input type="text" min='0' v-model="fiPhone" class="form-control fixo" id="fiPhone"
			...
			<template id="step7">
				<div class="container text-center">
					...
					<div class="">
						<a :href="myCUD"
						   id="drop-zoneCUDLabel"><?php echo get_option($incluyemeNames) ? get_option($incluyemeNames) : 'Laudo Médico'; ?></a>
						<x-incluyeme class="row m-auto">
							<x-incluyeme class="col-12">
				...
				<div class="container" v-for="(formFields2, pos) in formFields2" :key="pos">
					...
					<x-incluyeme class="row mt-2">
						<x-incluyeme class="col-lg-6 col-md-12">
							...
							<select id="levelExperience" class="form-control">
						...
						<label for="salario" class="">Último salário recebido</label>
							<input v-model="jobsSalario[pos]" type="text" class="form-control" id="salario" placeholder="Salário">
						</x-incluyeme>
