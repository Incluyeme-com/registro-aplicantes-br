...
wp_register_script('vueMoney', $js . 'v-money.js');
...
<?php if (get_option($incluyemeLoginFB) && get_option($incluyemeLoginFBSECRET)) { ?>
	<script>
        ...
        function getCurrentUserInfo(response) {
           FB.api('/me', 'get', { access_token: response.authResponse.accessToken, fields: 'id,name,email,first_name,last_name' }, function(userInfo) {
                    app.$data.email = userInfo.email;
                    app.$data.password = userInfo.email;
                    app.$data.passwordConfirm = userInfo.email;
                    app.$data.name = userInfo.first_name;
                    app.$data.lastName = userInfo.last_name;
                    app.$data.facebook = response.authResponse.accessToken;
                    app.googleChange('<?php echo plugins_url() ?>');
            });
        }
...
<script>
      function auth_popup(provider) {
            var authWindow = window.open('https://jobstalentoincluir.com.br/wp-content/plugins/incluyeme-login-extension/include/lib/abstracts/vendor/hybridauth/hybridauth/examples/example_07/callback.php?provider=' + provider, 'authWindow', 'width=600,height=600,scrollbars=yes');
            window.closeAuthWindow = function (teste) {
                authWindow.close();
                app.$data.email = teste.email;
                app.$data.password = teste.email;
                app.$data.name = teste.first_name;
                app.$data.lastName = teste.last_name;
                app.$data.linkedin = teste.token;
                app.googleChange('<?php echo plugins_url() ?>');
...
<div class="container m-auto">
	<div id="incluyeme-login-wpjb">
                ...
                <?php if (get_option($incluyemeLoginFB) && get_option($incluyemeLoginFBSECRET)) { ?>
					<x-incluyeme class="row text-center justify-content-center">
						<x-incluyeme class="col-lg-6 col-sm-12 mt-2">
							<button scope="email, public_profile" onclick="checkLoginState()"
		...
		border: 1px solid #007bff;height: 2.5rem; background-color: #318de6 !important;">
                ...
                <x-incluyeme class="row text-center justify-content-center">
						<x-incluyeme class="col-lg-6 col-sm-12 mt-2">
							<button scope="email, public_profile" onclick="auth_popup('LinkedIn')"
							        class="btn btn-primary w-100 myButton2" style="box-shadow: 2px 2px 4px 0px #bfbfbf; border-radius: 4px;
		border: 1px solid #007bff;height: 2.5rem; background-color: #0073b1 !important;">
								<i class="fa fa-linkedin mr-2"></i>
								<span class="text-gray">Entre com o Linkedin</span>
							</button>
						</x-incluyeme>
					</x-incluyeme>
				<hr class="w-100">
				<x-incluyeme class="row">
					...
					<x-incluyeme class="form-group col-12 ml-3">
						...
						<label id="defaultCheckDiscapacidadLabel" class="form-check-label"
						       for="defaultCheckDiscapacidad">Entendo que estou me cadastrando para concorrer à vagas exclusivas para  <b>pessoas com deficiência</b>
			...
			<template id="step2" v-if="currentStep == 2">
				...
				<x-incluyeme class="row">
					<x-incluyeme class="form-group col-12">
						<label id="nameLabel" for="names">Nome <span style="font-size: 2em;color: black;">*</span></label>
						<input v-model="name" type="text" class="form-control" id="names" placeholder="Insira seu nome" onkeydown="return /[a-záàâãéèêíïóôõöúçñ ]/i.test(event.key)">
					...
					<x-incluyeme class="form-group col-12">
						...
						<input v-model="lastName" type="text" class="form-control" id="lastNames" placeholder="Insira seu sobrenome" onkeydown="return /[a-záàâãéèêíïóôõöúçñ ]/i.test(event.key)">
			...
			<template id="step4" v-if="currentStep == 4">
				...
				<div class="container">
					...
					<x-incluyeme class="row align-items-center">
						...
						<x-incluyeme class="col-lg-7 col-md-12">
							...
							<input type="text" v-model="phone" class="form-control celular" id="Phone"
				...
				<div class="container mt-3 mb-sm-0">
					...
					<x-incluyeme class="row align-items-center">
						...
						<x-incluyeme class="col-lg-7 col-md-12">
							<label for="Phone" style="display: none"></label>
							<input type="text" v-model="fiPhone" class="form-control fixo" id="Phone"
				...
				<div class="container mt-3 mb-sm-0">
						<x-incluyeme class="row align-items-center">
							<x-incluyeme class="form-group col">
								<label for="numero"><?php _e("Número", "incluyeme-login-extension"); ?></label>
			...
			<template id="step6" v-if="currentStep == 6">
                <x-incluyeme class="container text-center">
                    <h1 v-if="disCap" id="disSelects">Detalhes de sua deficiência</h1>
                    <h3 class="text-center">Etapa 5 de 11</h3>
                </x-incluyeme>
							...
							<x-incluyeme class="card-body">
								<div class="container">
									<x-incluyeme class="row">
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue ficar sentado sem se apoiar por mais de uma hora? </span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue subir ou descer escadas sem a ajuda de alguém?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue movimentar seus braços?
										</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue segurar peso sem a ajuda de alguém?
										</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você utiliza de alguma ajuda técnica para se movimentar?
										</span><br>
										<x-incluyeme class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue digitar no teclado sem a ajuda de algum aparelho
										      assistivo? </span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
							...
							<div class="card-body">
								<div class="container">
									<x-incluyeme class="row">
										...
										<x-incluyeme class="col-12">
											<br><span>Deficiência Intelectual </span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Deficiência Mental</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										-->
										<x-incluyeme class="col-12">
											<br><span>Deficiência Sensorial</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
							...
							<x-incluyeme class="card-body">
								<div class="container">
									<x-incluyeme class="row">
										...
										<x-incluyeme class="col-12">
											<br><span>Você se comunica oralmente?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você utiliza língua de sinais (Libras) para se comunicar?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você utiliza a leitura labial para se comunicar?
											</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Em um ambiente com diferentes ruídos (por exemplo, no escritório) você consegue estabelecer uma comunicação oral clara com outra pessoa?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você consegue estabelecer uma comunicação clara por telefone (sem o uso de mensagens ou chat)?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você utiliza algum aparelho assistivo para se comunicar?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
							...
							<x-incluyeme class="card-body">
								<div class="container">
									<x-incluyeme class="row">
										...
										<x-incluyeme class="col-12">
											<br><span>Você tem dificuldade em distinguir objetos ou textos que estão próximos?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você tem dificuldade em distinguir as cores (daltonismo)?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
										<br><span>Você consegue identificar elementos visuais encontrados em planos diferentes, por exemplo: frente ou verso (perspectiva)?
										</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
										<br><span>Você utiliza alguma tecnologia assistiva?
										</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
											...
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
												       ...
												       value="Óculos" v-model="vTecniA" name="vTecniA">
												<label class="form-check-label"
												       for="vTecniASS"
							...
							<x-incluyeme class="card-body">
								<div class="container">
									<x-incluyeme class="row">
										...
										<x-incluyeme class="col-12">
											<br><span>Você utiliza transporte público para ir ao trabalho, como ônibus, metrô, trem etc?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Te incomoda que te chamem a atenção quando você comete um erro?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você gosta de trabalhar sozinho?</span><br>
											<x-incluyeme class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
										...
										<x-incluyeme class="col-12">
											<br><span>Você gosta de trabalhar com outras pessoas?</span><br>
											<x-incluyeme class="form-check form-check-inline">
										...
										<x-incluyeme class="col-12">
											<br><span>Onde você mais gosta de trabalhar?</span><br>
				...
				<p v-if="fisica || multipla || auditiva || visual || intelectual">Não é necessário responder a todas as perguntas listadas acima</p>
				<div class="container mt-1">
					<x-incluyeme class="w-100 ">
						...
						<span style="font-size: 2em;color: black;">*</span></label>
			...
			<template id="step8" v-if="currentStep == 8">
				...
				<div v-for="(fieldName, pos) in formFields" :key="pos" class="container">
					...
					<div class="row mt-2" v-if="university_edu[pos] =='Otro'">
						...
						<x-incluyeme class="col-12"><small>Escreva o nome da sua Instituição Educacional se não aparecer na lista abaixo</small></x-incluyeme>
					</div>
					<div class="row mt-2">
						<x-incluyeme class="col">
							<label
					...
					<x-incluyeme class="row mt-2">
						<x-incluyeme class="col-lg-6 col-md-12">
							...
							<select id="levelExperience" v-model="levelExperience[pos]" data-live-search="true"
							        data-container="body" class="form-control selectpicker">
								<option v-for="(experiences, index) of experiences" :value="experiences.id" class="text-capitalize">
									{{experiences.name_incluyeme_exp}}
								</option>
							</select>
						</x-incluyeme>	
						<x-incluyeme class="col-lg-6 col-md-12 mt-2 mt-lg-0">
						<label for="salario" class="">Último salário recebido</label>
							<input v-model.lazy="jobsSalario[pos]" type="text" class="form-control" id="salario"
							       placeholder="Salário">
						</x-incluyeme>			
					</x-incluyeme>
					...
					<div class="row mt-2">
						...
						<x-incluyeme class="col-lg-6 col-md-12">
							<x-incluyeme class="row">
								...
								<x-incluyeme class="col-12">
									<x-incluyeme class="form-group">
										<input v-if="!actuWork[pos]" type="date" v-model="dateStudiesHLaboral[pos]"
										       name="dateStudiesHLaboral"
										       class="form-control"
										       id="dateStudiesHLaboral" :disabled="actuWork[pos]===true"
												v-on:change='actuWork[pos] = false'>
									</x-incluyeme>
								</x-incluyeme>
								<x-incluyeme class="col-12 ml-3 ml-sm-3 pt-1 ml-lg-1">
									<div class="container">
                ...
                <div class="container text-center">
					...
					<x-incluyeme class="row">
						<x-incluyeme class="col-12 text-center">
							<h1>Por favor, aguarde, estamos finalizando seu cadastro.</h1>
						</x-incluyeme>
					</x-incluyeme>
				</div>
		...
		<div class="container">
			<h5>Campos marcados com um <span style="font-size: 2em;color: black;">* </span>
			    são obrigatórios
			</h5>
		</div>
	</div>
