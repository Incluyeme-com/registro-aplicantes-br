...
try {
     ...
     */
    HttpClient\Util::redirect('https://jobstalentoincluir.com.br/wp-content/plugins/incluyeme-login-extension/include/lib/abstracts/vendor/hybridauth/hybridauth/examples/example_06/index.php');
} catch (Exception $e) {
    echo $e->getMessage();
}
